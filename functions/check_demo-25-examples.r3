...
;;============================================================================
;; Centralize all series validation logic to avoid code duplication.
;; Provide a consistent interface for checking series validity and reporting results.
validate-series: function [
    "Validate a series value with comprehensive error handling."
...
;;==========================================================================
example-01: function [
    "Demonstrates proper basic string validation using the `check` function with error handling."
][
...
;;==========================================================================
;; EXAMPLE 11: Advanced Format Checking
;;
;; Purpose: Demonstrates using custom formatters with validation.
;;
;; Key concepts:
;; - Custom formatting for different series types.
;; - Shows how to enhance validation output.
;; - Demonstrates custom formatter functions.
;;==========================================================================
example-11: function [
    "Demonstrates validation with custom formatting using the `check` function."
][
...
;;
;; Purpose: Demonstrates validation of email strings.
;;
;; Key concepts:
;; - Email address validation.
;; - Shows that `check` handles special string formats.
;; - Demonstrates converting values to strings.
;;==========================================================================
example-12: function [
...
;;
;; Purpose: Demonstrates validation of multi-line strings.
;;
;; Key concepts:
;; - Multi-line string validation.
;; - Shows that `check` handles strings with newlines.
;; - Demonstrates validation of complex string formats.
;;==========================================================================
example-13: function [
...
;;==========================================================================
;; EXAMPLE 14: Mixed Data Types in Block Checking
;;
;; Purpose: Demonstrates validation of blocks with mixed data types.
;;
;; Key concepts:
;; - Block with heterogeneous content.
;; - Shows that `check` handles diverse data types.
;; - Demonstrates validation of complex blocks.
;;==========================================================================
example-14: function [
...
;;==========================================================================
;; EXAMPLE 15: Block Removal Operations Checking
;;
;; Purpose: Demonstrates validation after various block removal operations.
;;
;; Key concepts:
;; - Remove operations on blocks.
;; - Shows that `check` verifies series after removal.
;; - Demonstrates that removal preserves series structure.
;;==========================================================================
example-15: function [
...
;;
;; Purpose: Demonstrates validation of strings after parsing operations.
;;
;; Key concepts:
;; - String splitting and parsing.
;; - Shows that `check` verifies parsed string fragments.
;; - Demonstrates validation in a loop.
;;==========================================================================
example-16: function [
...
;;==========================================================================
;; EXAMPLE 17: Copied Series Checking
;;
;; Purpose: Demonstrates validation of original and copied series.
;;
;; Key concepts:
;; - Series copying operations.
;; - Shows that `check` verifies both original and copy.
;; - Demonstrates that copies are independent series.
;;==========================================================================
example-17: function [
...
;;==========================================================================
;; EXAMPLE 18: Series at Different Positions Checking
;;
;; Purpose: Demonstrates validation of series at different positions.
;;
;; Key concepts:
;; - Series position operations.
;; - Shows that `check` works at any series position.
;; - Demonstrates series navigation.
;;==========================================================================
example-18: function [
...
;;==========================================================================
;; EXAMPLE 19: Skip Results Checking
;;
;; Purpose: Demonstrates validation after skip operations.
;;
;; Key concepts:
;; - Series skip operations.
;; - Shows that `check` works after repositioning.
;; - Demonstrates forward and backward navigation.
;;==========================================================================
example-19: function [
...
;;==========================================================================
;; EXAMPLE 20: Reversed Series Checking
;;
;; Purpose: Demonstrates validation of series after reversal.
;;
;; Key concepts:
;; - Series reversal operations.
;; - Shows that `check` verifies series after reversal.
;; - Demonstrates in-place series transformation.
;;==========================================================================
example-20: function [
...
;;==========================================================================
;; EXAMPLE 21: Sorted Series Checking
;;
;; Purpose: Demonstrates validation of series after sorting.
;;
;; Key concepts:
;; - Series sorting operations.
;; - Shows that `check` verifies series after sorting.
;; - Demonstrates in-place series transformation.
;;==========================================================================
example-21: function [
...
;;==========================================================================
;; EXAMPLE 22: Unicode Content Checking
;;
;; Purpose: Demonstrates validation of series with Unicode characters.
;;
;; Key concepts:
;; - Unicode string validation.
;; - Shows error handling for unsupported Unicode.
;; - Demonstrates fallback to ASCII when needed.
;;==========================================================================
example-22: function [
...
;;==========================================================================
;; EXAMPLE 23: Error Handling Context
;;
;; Purpose: Demonstrates using `check` within error handling contexts.
;;
;; Key concepts:
;; - Integration with Rebol error handling.
;; - Shows how to properly handle validation errors.
;; - Demonstrates try/with error handling.
;;==========================================================================
example-23: function [
...
;;==========================================================================
;; EXAMPLE 24: Pre-validation Before Critical Operations
;;
;; Purpose: Demonstrates pre-validating series before critical operations.
;;
;; Key concepts:
;; - Using `check` as a safety mechanism.
;; - Shows conditional execution based on validation.
;; - Demonstrates best practices for critical operations.
;;==========================================================================
example-24: function [
...
;;
;; Purpose: Demonstrates performance testing of the `check` function.
;;
;; Key concepts:
;; - Timing `check` operations.
;; - Shows performance characteristics with different sizes.
;; - Demonstrates error handling in performance testing.
;;==========================================================================
example-25: function [
    ...
    foreach size sizes [
        ;; Create a test block of the specified size efficiently:
        test-block: make block! size
        ...
        ;; Report result with error information if needed:
        either error? result [
            print rejoin ["Size: " size " elements, Check ❌ FAILED with error: " result/id]
        ][
            print rejoin ["PASSED: Size: " size " elements, Check time: " time-diff]
        ]
    ]
]

;;==========================================================================
print "=== REBOL 3 `check` FUNCTION - A COMPREHENSIVE EXAMPLES GUIDE ==="
print "Running all examples in numeric sequence..."
example-01
example-02
example-03
example-04
