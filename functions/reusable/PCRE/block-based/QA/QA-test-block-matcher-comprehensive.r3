...
set [test-count pass-count fail-count] 
    assert-equal false ExecuteBlockMatch "say hello" ['start #"h" #"e" #"l" #"l" #"o"] "Start anchor no match" test-count pass-count fail-count
...
set [test-count pass-count fail-count] 
    assert-equal false ExecuteBlockMatch "" [#"a"] "Empty string, non-empty rules" test-count pass-count fail-count
