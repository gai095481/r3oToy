    ...
    either none? blkRules [
        ...
        set/any 'parse-result try [
            either is-exact-quantifier [
                ;; EXACT QUANTIFIER FIX - Use anchored matching for exact quantifiers like \d{3}
        ...
        either error? parse-result [
            ...
            either is-exact-quantifier [
                ;; EXACT QUANTIFIER FIX - For exact quantifiers, only return match if parse succeeded
                either parse-result [
