...
print "8. FIXED: When applying functions, ensure argument types match function expectations"
print "9. FIXED: Conditional function selection works with proper function references and arguments"
