...
part-negative-result: sort/part copy test-part-negative -1
assert-equal test-part-negative part-negative-result "Part with negative count should not change the series"
...
; Elements closest to 3 should come first: 2, 4, 1, 5, 6
...
;; HYPOTHESIS: /skip with /all is not a valid combination
test-all-data: [
    [1 "zebra"] [1 "apple"] [2 "banana"]
]
set/any 'all-result try [sort/skip/all copy test-all-data 2]
either all-result [
    print "✅ PASSED: Sort with /skip and /all properly generates error"
][
    print "❌ FAILED: Sort with /skip and /all should generate error"
    set 'all-tests-passed? false
]
