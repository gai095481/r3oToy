...
source-obj: context [a: 90000 b: 91000 c: 92000 d: 93000]
target-obj: context [a: 1 b: 2 d: 4 e: 5 f: 6]

print ["Target words before resolve:" mold words-of target-obj]
print ["Source words:" mold words-of source-obj]

;; Perform the operation
resolve/only/all target-obj source-obj 3

print ["Target words after resolve:" mold words-of target-obj]
...
assert-equal 1 target-obj/a "Word 'a' (before index 3) should be unchanged"
assert-equal 2 target-obj/b "Word 'b' (before index 3) should be unchanged"

;; HYPOTHESIS: The word at the index is resolved if it exists in the source.
assert-equal 93000 target-obj/d "Word 'd' (at index 3) should be overwritten by source"

;; HYPOTHESIS: Words in the target that are AFTER the start index and do NOT exist
;; in the source object are made UNSET.
assert-equal true unset? get in target-obj 'e "Word 'e' should now be unset"
assert-equal true unset? get in target-obj 'f "Word 'f' should now be unset"
